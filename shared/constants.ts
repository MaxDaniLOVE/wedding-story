...
export const LINKS = [
  ...
  { id: LINK_IDS.PLACE, label: 'Место проведения' },
  { id: LINK_IDS.HOW_TO_GET, label: 'Как добраться' },
  { id: LINK_IDS.APARTMENTS, label: 'Где жить' },
  { id: LINK_IDS.DRESS_CODE, label: 'Дресс-код' },
